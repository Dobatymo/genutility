...
class FuzzyTest(MyTestCase):
	...
	def test_extract_all(self):
		truth = []
		result = extract("asd", [], max_distance=-1, limit=-1)
	...
	def test_extract_md0(self):
		truth = []
		result = extract("asd", [], max_distance=0, limit=-1)
		self.assertEqual(truth, result)
	...
	def test_extract_l0(self):
		truth = []
		result = extract("asd", [], max_distance=-1, limit=0)
		self.assertEqual(truth, result)
	...
	def test_extract_l2(self):
		truth = []
		result = extract("asd", [], max_distance=-1, limit=2)
		self.assertEqual(truth, result)
