...
Availability = {
    "messages": [{"type": "Availability", "message": {"results": [{"id": "button-id", "isAvailable": True}]}}]
}
...
MessagesReceive = [
    ...
    {"type": "ChatMessage", "message": {"text": "Liveagent Message", "name": "Liveagent Name"}},
    {"type": "AgentNotTyping", "message": {}},
]

Messages = {"messages": MessagesReceive, "sequence": 4}
