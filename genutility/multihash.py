...
if __name__ == "__main__":
	...
	funcs = (
		"CRC32", "MD4", "MD5", "SHA1", "TIGER", "TTH", "BTIH", "ED2K", "AICH", "WHIRLPOOL",
		"RIPEMD-160", "GOST12_256", "GOST12_512", "GOST94", "GOST94_CRYPTOPRO", "HAS-160", "SNEFRU-128", "SNEFRU-256", "SHA-224",
		"SHA-256", "SHA-384", "SHA-512", "EDON-R256", "EDON-R512"
	)

	parser = argparse.ArgumentParser(description="Multi file hashing", epilog="Example: multihash C:\\Windows\\System32\\calc.exe -f CRC32 SHA1")
