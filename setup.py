...
extras_require = {
    ...
    "videofile": ["opencv-python", "av>=8.0"],
    "win32": ["wmi", "pypiwin32"],
    "widgets": ["wxPython"],
    "xsl": ["lxml"],
    ...
    "rasa": ["requests", "aiohttp>=3.7.4", "ruamel.yaml"],
    "salesforce": ["simple-salesforce>=1.1.0", "simplejson", "aiohttp>=3.7.4", "requests", "pandas"],
    "scipy": ["numpy", "scipy<1.8.0"],
    "spark": ["pyspark>=3.0.0"],
    "toml": ["toml"],
    "torch": ["torch"],
    "twisted": ["twisted"],
